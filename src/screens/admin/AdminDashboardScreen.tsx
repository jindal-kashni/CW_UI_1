...
export default function AdminDashboardScreen() {
  ...
  const reportsDueByDate = React.useMemo(
    () =>
      reports.reduce<Record<string, typeof reports>>((acc, report) => {
  ...
  const urgentAlertsByDate = React.useMemo(
    () =>
      alerts
        ...
        .reduce<Record<string, typeof alerts>>((acc, alert) => {
  ...
  const syncActivityByDate = React.useMemo(
    () =>
      syncItems.reduce<Record<string, typeof syncItems>>((acc, item) => {
